...
**Tests**: Per DomoticsCore Constitution (Principle II - TDD), tests are MANDATORY. Every phase requires 100% test coverage before proceeding to the next phase.
...
**Phase Gate (Constitution Principle II):**
- [ ] All tests written for User Story 1
- [ ] All tests pass (100% green)
- [ ] Test coverage = 100% for this phase
- [ ] File sizes < 800 lines
- [ ] No compiler warnings

**Checkpoint**: User Story 1 fully functional and tested. Phase gate MUST pass before proceeding.
...
**Phase Gate (Constitution Principle II):**
- [ ] All tests written for User Story 2
- [ ] All tests pass (100% green)
- [ ] Test coverage = 100% for this phase
- [ ] File sizes < 800 lines
- [ ] No compiler warnings

**Checkpoint**: User Stories 1 AND 2 fully functional and tested. Phase gate MUST pass before proceeding.
...
**Phase Gate (Constitution Principle II):**
- [ ] All tests written for User Story 3
- [ ] All tests pass (100% green)
- [ ] Test coverage = 100% for this phase
- [ ] File sizes < 800 lines
- [ ] No compiler warnings

**Checkpoint**: All user stories fully functional and tested. Phase gate MUST pass before proceeding.
...
| TDD | Test coverage = 100% for phase | ☐ |
| SOLID | SRP: Each file has single responsibility | ☐ |
