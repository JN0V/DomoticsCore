...
// Console history, in lines: 64 lines of 120 characters hold 11.8 KB on a WROOM-32D,
// taken as lines arrive, so it shows as free heap settling over the first hours.
#define DOMOTICS_LOG_BUFFER_SIZE 64
