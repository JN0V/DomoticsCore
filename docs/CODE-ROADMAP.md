...
- **Verification**: two native cases on the scriptable stub, both failing when
  the guard is removed; on the WROOM-32D the console suite dropped the
  ...
  mbox)` and reboots. 8/8 on the nodemcuv2, where nothing changes.
...
| **Total** | **194 items** | | **0C, 0H, 26M, 56L** (125 resolved) |
