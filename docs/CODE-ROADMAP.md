...
| **Total** | **149 items** | | **0C, 0H, 34M, 33L** (95 resolved) |
...
2 + 4 + 6 + 3 + 3 + 1 + 4 + 11 + 0 + 0 — a read-only observation of a production broker on 2026-09-18 filed one MEDIUM and it was fixed the same day (BUG-43, no column move, total 148 → 149, resolved 94 → 95); BUG-41's lot on 2026-09-18 filed one MEDIUM
