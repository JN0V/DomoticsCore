...
| **Total** | **185 items** | | **0C, 0H, 27M, 55L** (116 resolved) |

The severity columns sum across the rows. **The HIGH column moved four
times on 2026-09-22 and ended at zero**: SEC-16 was closed by a fix, the
