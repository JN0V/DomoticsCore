...
void tearDown(void) {
    ...
    // autogenerated AP — and the WiFi stub's mode/AP record is process-global
    // (TEST-4). Nothing in this suite reads HAL mode today; reset anyway so a
    // future assertion cannot pass or fail on the previous test's state.
